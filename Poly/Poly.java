...
public final class Poly {
	 ...
	 * @param p1 polynomial expression.
	 * @param p2 polynomial expression.
	 * @return added polynomial expression
	 */
	public static Poly addPoly(Poly p1, Poly p2) {
		int arrayP1[] = p1.expression;
		int arrayP2[] = p2.expression;
	...
	public void show() {
		...
		for (int i = 0; i < p1.expression.length; i = i + 2)
			// : p1.expression)
