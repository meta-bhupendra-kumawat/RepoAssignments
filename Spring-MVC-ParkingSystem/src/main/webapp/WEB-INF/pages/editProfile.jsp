...
<div class="d-flex justify-content-center"><h2>Edit Employee Details</h2></div>
	<div align="center">
		<form:form  modelAttribute="employee" action="/editProfile">
		<div align="center">${duplicateKeyError}</div>
			...
			<div class="form-group row col-md-4 row">
				...
				<form:input path="contact" cssClass="form-control"
					id="6" placeholder="Enter Contact" />
				<form:errors path="contact" cssClass="text-danger" />
			</div>
			<div class="form-group row col-md-4 row">
				<form:label path="company">Company&emsp;&emsp;</form:label>
				<form:select path="company">
					<form:option path="company" value="NULL" label="--- Select ---" />
					<form:options path="company" items="${companyList}"
						var="companyName" />
				</form:select>
