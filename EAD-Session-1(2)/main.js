...
function validateEmployee() {
    ...
    if (password.length == 0 || password !== confirmpassword) {
        ...
        document.getElementById("password-error").innerHTML = "<font size='2' color='red'>Password should contains Uppercase, Lowercase,<br> Numeric & Alphanumeric.</font>";
        flag = false;
    }
    ...
    if (regex.test(email)) {
        document.getElementById("email-error").innerHTML = "<font size='2' color='red'>Invalid email.</font>";
        flag = false;
    }
